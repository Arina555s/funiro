(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-rooms")) new core(".slider-rooms__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            autoHeight: true,
            ...
            navigation: {
                nextEl: ".slider-rooms_prevs ",
                prevEl: ".slider-rooms_prevs "
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
        ...
        if (document.querySelector(".slider-tips")) new core(".slider-tips__slider", {
